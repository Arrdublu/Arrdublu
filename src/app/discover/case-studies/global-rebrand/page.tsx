        ...
        <div className="max-w-4xl mx-auto">
          ...
          <section className="mb-12">
            ...
            <section className="mb-12">
                ...
                {caseStudy.instagramEmbeds.map((embed, index) => (
