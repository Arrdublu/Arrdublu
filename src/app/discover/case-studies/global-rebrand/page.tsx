        ...
        <div className="max-w-4xl mx-auto">
          <div className="prose prose-lg max-w-none mx-auto">
              ...
              <div
                ...
                dangerouslySetInnerHTML={{ __html: caseStudy.instagramEmbed }}
              />
