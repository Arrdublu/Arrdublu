      ...
      <Card>
        ...
        <CardContent className="prose prose-lg max-w-none">
           <h2>1. Introduction</h2>
            ...
            <p>For services that involve the creation of media (including but not limited to photography and videography), you grant Arrdublu a perpetual, worldwide, royalty-free license to use, reproduce, display, and distribute the resulting media for our promotional and commercial purposes. This includes, but is not limited to, use on our website, social media platforms, and monetized channels such as YouTube. We will make a reasonable effort to notify you when your project is featured. If you wish to opt-out or require a specific release form, please contact us prior to the commencement of the project to discuss alternative arrangements.</p>
