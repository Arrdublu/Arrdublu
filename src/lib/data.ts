...
export const services: Service[] = [
  ...
  },
  {
    ...
    previews: ['https://images.unsplash.com/photo-1614181861755-cf660935851a?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3NDE5ODJ8MHwxfHNlYXJjaHwxMXx8cG9ydHJhaXQlMjBzZXNzaW9ufGVufDB8fHx8MTc1NTU4NTY0MHww&ixlib=rb-4.1.0&q=80&w=1080', 'https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1200&q=80'],
